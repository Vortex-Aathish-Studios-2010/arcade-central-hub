  ...
  return (
    <div className="flex flex-col items-center gap-4 p-4">
      <div className="flex gap-4 text-sm font-display text-muted-foreground">
        ...
        <span className={`flex items-center gap-1 ${elapsed > 120 ? "text-destructive" : elapsed > 60 ? "text-accent" : "text-foreground"}`}>
          ...
          <motion.div
            ...
            className={`w-14 h-14 rounded-lg flex items-center justify-center font-display font-bold cursor-pointer transition-colors ${
              val === 0
                ...
                : "bg-card border-2 border-accent/40 text-accent hover:border-accent"
            }`}
          >
            {val > 0 ? val : ""}
          </motion.div>
